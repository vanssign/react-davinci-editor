...
import { SocialLinks, BootstrapColors } from '../functions/Constants';
...
export default function EditorHTML(props) {
    ...
    if (tag == "h1") {
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <h1 className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="H1 heading. Type here.."
    ...
    //H2
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <h2 className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="H2 Heading. Type here ..."
    ...
    //paragraph
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <p className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} value={content} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="Paragraph. Type here ..."
    ...
    //H3
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <h3 className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="H3 Heading. Type here ..."
                    onKeyDown={(e) => KeyDown(e)} onFocus={() => props.handleFocus(props.index)} />
                </h3>
            </div>)
    }
    ...
    //H4
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <h4 className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="H4 Heading. Type here ..."
                    onKeyDown={(e) => KeyDown(e)} onFocus={() => props.handleFocus(props.index)} />
                </h4>
            </div>)
    }
    ...
    //H5
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <h5 className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="H5 heading. Type here ..."
                    onKeyDown={(e) => KeyDown(e)} onFocus={() => props.handleFocus(props.index)} />
                </h5>
            </div>)
    }
    ...
    //H6
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <h6 className={allClasses + `w-100 align-self-${props.element.alignSelf}`}><TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="H6 Heading. Type here ..."
                    onKeyDown={(e) => KeyDown(e)} onFocus={() => props.handleFocus(props.index)} />
                </h6>
            </div>)
    }
        ...
        return (
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <code className={allClasses + ` w-100 align-self-${props.element.alignSelf}`}>
                    <TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="Code Snippet. Type here ..."
            ...
            <div className={containerClasses + activeBorder} onClick={() => props.handleFocus(props.index)}>
                <div className={`w-100 align-self-${props.element.alignSelf}`}>
                    <blockquote className={allClasses + " blockquote"}>
                        <p className="mb-0">
                            <TextareaAutosize style={{ overflow: 'hidden' }} value={content} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="BlockQuote text. Type here ..."
                                onKeyDown={(e) => KeyDown(e)}
                                onFocus={() => props.handleFocus(props.index)} />
                        </p>
                        <footer className="blockquote-footer">
                            <TextareaAutosize style={{ overflow: 'hidden', width: '20vw' }} value={props.element.cite} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "cite", "", "", e.target.value)} placeholder="Cite Title here..."
                                onKeyDown={function (e) {
                                    if (e.key === "Control" && e.key === "Delete") {
                                        e.preventDefault();
                                        props.deleteElement(props.index);
                        ...
                        {props.element.slides.map((slide, i) =>
                            <Carousel.Item key={tag + props.index + "slide" + i}>
                                ...
                                <Carousel.Caption className={`text-${slide.textColor}`}>
                                    <h3><TextareaAutosize style={{ overflow: 'hidden' }} value={slide.label} className="textareaInherit" onChange={(e) =>
                                    ...
                                    <p><TextareaAutosize style={{ overflow: 'hidden' }} value={slide.caption} className="textareaInherit" onChange={(e) =>
            ...
            <div className={`w-100 align-self-${props.element.alignSelf} text-${props.element.alignment}`}>
                <button type="button" className={props.element.btnOutline ? (`btn btn-${props.element.size} btn-outline-${props.element.btnColor}`) : (`btn btn-${props.element.btnColor} btn-${props.element.size}`)} style={{ position: 'relative' }}>
                    <div className="d-flex justify-content-start">
                        ...
                        <TextareaAutosize style={{ overflow: 'hidden' }} value={content} className="textareaInheritBtn" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} placeholder="Button Text. Type here ..." onFocus={() => props.handleFocus(props.index)} onKeyDown={(e) => KeyDown(e)} />
            ...
            <div className={`text-${props.element.alignment} p-0` + containerClasses + activeBorder + allClasses} onClick={() => props.handleFocus(props.index)}>
                <Navbar bg={props.element.bgColor} variant={props.element.bgColor} expand="lg">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Navbar.Text>
                            <button type="button" onClick={() => props.deleteElement(props.index)} className="delBtn"><i className="bi bi-x-circle-fill lead"></i></button>
                        </Navbar.Text>
                    </Navbar.Collapse>
                </Navbar>
            </div>
    ...
    //LISTS
        ...
        return (
            <li className={activeBorder}>
                4<TextareaAutosize style={{ overflow: 'hidden' }} ref={props.focusedIndex == props.index ? (FocusedElement) : (null)} value={content} className="textareaInherit" onChange={(e) => props.updateElement(props.index, "content", "", "", e.target.value)} placeholder="List Item. Type here ..." onKeyDown={function (e) {
                    if (e.key === 'Enter') {
                        e.preventDefault();
                        props.addElement("li");
                    }
